#ifndef QUICHE_QUIC_CORE_PROXYQUIC_PACKET_READER_H_
#define QUICHE_QUIC_CORE_PROXYQUIC_PACKET_READER_H_
...
class QuicProxyPacketReader : public QuicPacketReader {
 public:
  explicit QuicProxyPacketReader();
  QuicProxyPacketReader(const QuicProxyPacketReader&) = delete;
  QuicProxyPacketReader& operator=(const QuicProxyPacketReader&) = delete;

  ~QuicProxyPacketReader() override;
...
#endif  // QUICHE_QUIC_CORE_PROXYQUIC_PACKET_READER_H_
